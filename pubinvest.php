      ...
      <div class="container">
        ...
        <form action="forms/appointment.php" method="post" role="form" class="php-email-form">
          ...
          <div class="col-md-4 form-group mt-3 mt-md-0">
            <input type="text" class="form-control" name="phone" id="phone" placeholder="Titre" >
            <div class="validate"></div>
           </div>
          <div class="col-md-4 form-group mt-3 mt-md-0">
            <input type="text" class="form-control" name="phone" id="phone" placeholder="Type" >
            <div class="validate"></div>
           </div>
            <div class="col-md-4 form-group mt-3 mt-md-0">
            <input type="number" class="form-control" name="phone" id="phone" placeholder="Contact" >
            <div class="validate"></div>
           </div>
          <div class="form-group mt-3">
            <textarea class="form-control" name="message" rows="5" placeholder="Investissement"></textarea>
            <div class="validate"></div>
          </div>
          <div class="mb-3">
