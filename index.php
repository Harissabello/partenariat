...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#Nos collaborateurs">Nos collaborateurs</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>Bienvenu à Financeproject</h1>
      <h2>Nous Finançons tout sort de projets</h2>
      <a href="login.php" class="btn-get-started scrollto">Connectez-Vous</a>
    </div>
  </section><!-- End Hero -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              <h3>Pourquoi choisir Financeproject?</h3>
              <p>
                Financeproject est une entreprise .
              </p>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Comment deposer son projet sur Financeproject?</h4>
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Voire les personnes interreter par votre projet</h4>
                ...
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Voir la sélection de vos projets</h4>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h3>À propos de Financeproject </h3>
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                <h4>Reine Ahodakin</h4>
                <span>Chargé de la communication</span>
                <p>Stagiaire chez Simplon.ci</p>
                <div class="social">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/doctors/doctor.png" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Amani st clait</h4>
                <span>Chef de projet</span>
                <p>Formateur à Simplon.ci</p>
                <div class="social">
                  <a href=""><i class="ri-twitter-fill"></i></a>
                  <a href=""><i class="ri-facebook-fill"></i></a>
                  <a href=""><i class="ri-instagram-fill"></i></a>
